"""
panel-b.py — neutral "after" panel sample for the dev design-system gallery (DiagramRow).
Body uses the shared diagram system (assets-source/svg/_theme.py). Run from repo root:
  .venv/bin/python3 assets-source/svg/design-system-samples/panel-b.py
"""
...
BODY = """  <rect class="n" x="20" y="20" width="140" height="44" rx="4"/>
  ...
  <rect class="na" x="20" y="98" width="140" height="44" rx="4"/>
  <text class="lbl" x="90" y="125" text-anchor="middle">Layer 2</text>"""

_theme.build(
    out_rel="public/design-system/samples/panel-b.svg",
    title="Sample panel B",
    aria_label="Neutral sample panel B: two stacked layers with the second highlighted.",

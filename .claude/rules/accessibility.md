...
Full requirements in `docs/PRODUCT.md` §10 and `docs/DESIGN.md` — Accessibility Rules.
...
- Focus ring style is defined in `docs/DESIGN.md` — Accessibility Rules — use the `focus-ring` token

...
contract (`design-writing-contract.md`, owned by the design skills). It governs PRODUCT, the
implementation-plan doc, CONTENT-SCHEMA, and similar prose docs — never DESIGN.md.
...
- Design-agnostic. Describe *what* exists and *why*, never *how it looks*. No design tokens, no pixel
  values, no component internals, no framework specifics. Those live in DESIGN.md / CONTENT-SCHEMA.md
...
**Tier 2 — Companion / reference docs (CONTENT-SCHEMA.md, and most optional prose docs).**
